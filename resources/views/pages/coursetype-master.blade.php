        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-700">Course Type</li>
                </ul>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card card-flush mb-4">
                <div class="card-body py-4">
                    <div class="filter">
                        <form id="addEditForm" action="{{ route('save-coursetype') }}" method="POST" class="row">
                            @csrf
                            <input type="hidden" id="type_id" name="type_id">
                            <div class="col-lg-4">
                                <label class="form-label">Course Type<span class="mandat">*</span></label>
                                <input type="text" id="type_name" name="type_name" class="form-control mb-2"
                                    placeholder="Course Type Name" onkeypress="return allowAlphabetsSpaceNumbers(event);"
                                    maxlength="100">
            ...
            <div class="card card-flush">
                <div class="card-body">
                    <table class="table align-middle table-row-dashed fs-6 gy-3 checkbox-table" id="coursetype_table">
                        <thead>
                            <tr class="text-start fw-600 fs-6 gs-0">
                                <th class="min-w-40px">Sr. No.</th>
                                <th class="min-w-125px">Course Type</th>
...
@push('scripts')
    <script>
        ...
        var table = $("#coursetype_table").DataTable({
            processing: true,
            serverSide: true,
            //responsive: true,
            aLengthMenu: [
        ...
        function edit_data(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $("[name='type_id']").val(id);
                        $("[name='type_name']").val(response.data.type_name);
                        $("button[type='submit']").text('Update');
                        $("[name='type_name']").focus();
                    } else {
                        toastr.error(response.message);
                    }
                },
        ...
        function change_status(id, status) {
            ...
            $.ajax({
                url: "{{ route('change-coursetype-status') }}",
                method: 'post',
                data: formData,
                processData: false,
                dataType: "json",
        ...
        function resetForm() {
            ...
            $("form#addEditForm input[name='type_id']").val('');
            $("form").find('input, select, textarea').removeClass('is-invalid');
            $("form").find('span.error-text').text('');
